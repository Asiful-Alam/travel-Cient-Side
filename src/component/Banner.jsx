    ...
    <Swiper {...swiperParams}>
      <SwiperSlide>
        <div className="relative h-96 bg-cover bg-center flex items-center justify-center  z-0" style={{ backgroundImage: `url(${bannerImage})`, borderRadius: '20px' }}>
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
            <h2 className="text-4xl font-semibold mb-4">Discover Your Dream Home</h2>
            <p className="text-lg">Explore our curated selection of properties</p>
            <Link to="/properties" className="mt-6 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-full transition duration-300">View Properties</Link>
          </div>
        </div>
      </SwiperSlide>
      <SwiperSlide>
        <div className="relative h-96 bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: `url(${bannerImage})`, borderRadius: '20px' }}>
          <div className="absolute inset-0 bg-black opacity-50"></div>
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
            <h2 className="text-4xl font-semibold mb-4">Unlock Your Dream Home with Us!</h2>
            <p className="text-lg">Welcome to AshTek, your trusted partner in real estate excellence.</p>
      ...
      <SwiperSlide>
        <div className="relative h-96 bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: `url(${bannerImage})`, borderRadius: '20px' }}>
          <div className="absolute inset-0 bg-black opacity-50"></div>
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
            <h2 className="text-4xl font-semibold mb-4">Explore Exclusive Properties</h2>
            <p className="text-lg">Discover the finest properties in your desired location</p>
